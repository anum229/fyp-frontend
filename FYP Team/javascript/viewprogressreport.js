(function() {
    ...
    const API_URL = `${BASE_URL}/api/progress-reports/all`;
    ...
    // Set Group ID on the UI
    if (data.groupId) {
        const groupIdDiv = document.getElementById("group-id");
        groupIdDiv.textContent = `Group ID: ${data.groupId}`;
    }
}
    ...
    function renderReports(data) {
        ...
        data.forEach((report) => {
            ...
            listItem.innerHTML = `
                <div class="report-details">
                <strong>Group ID:</strong> ${report.groupId}<br>
